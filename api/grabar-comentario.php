...
$capitulo      = mysqli_real_escape_string($conexion, $_POST['capitulo']);
$nota           = mysqli_real_escape_string($conexion, $_POST['nota']);
$texto    = mysqli_real_escape_string($conexion, $_POST['texto']);

$query = "INSERT INTO comentarios (ID, ASUNTO, CAPITULO, NOTA, TEXTO) 
        VALUES (NULL,'$asunto', '$capitulo', '$nota', '$texto')";
